...
from widgets.pannel.communicationPannel.communicationPannel import communicationPannel
...
class tab_widget(QtGui.QWidget):
    def __init__(self, pannel, parent = None):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 795, 541))
...
class mainForm(QtGui.QMainWindow):
    def __init__(self, parent = None):
        ...
        self.func_insertTab(u'DataPort')
        self.pannel.append(tab_widget(communicationPannel, self))
        self.func_insertTab(u'DataPort')



    def func_insertTab(self, tabName):
        currentIndex = len(self.ui.tabw_pannel)
        self.ui.tabw_pannel.insertTab(currentIndex, self.pannel[currentIndex], unicode(tabName))
