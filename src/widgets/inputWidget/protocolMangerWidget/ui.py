...
#
# Created: Sat Sep 13 17:48:58 2014
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(10, 20, 141, 164))
        ...
        self.verticalLayout_7.addWidget(self.le_protocol_name)
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_save.setText(_translate("Form", "프로토콜 저장하기", None))
